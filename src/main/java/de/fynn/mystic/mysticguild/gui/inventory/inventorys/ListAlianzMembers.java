...
public class ListAlianzMembers extends PageInventory {


    public ListAlianzMembers(Player owner, CustomInventory previousInventory, String title, int rows, InventoryPage... pages) {
        super(owner, previousInventory, title, rows, pages);
    }

    public ListAlianzMembers(Player owner, String title, int rows, InventoryPage... pages) {
