...
public class ManageMember extends CustomInventory {


    public ManageMember(Player owner, CustomInventory previousInventory, String title, int size) {
        super(owner, previousInventory, title, size);
    }

    public ManageMember(Player owner, String title, int size) {
