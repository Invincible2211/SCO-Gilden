package de.fynn.mystic.mysticguild.system.file;
...
public class ConfigHandler {
    ...
    private static void init(){
        cfg = MysticGuild.getInstance().getConfig();
        cfg.options().copyDefaults(true);
        MysticGuild.getInstance().saveConfig();
        validateConfigs();
    }

    public static void validateConfigs(){
        ClassLoader classLoader = ConfigHandler.class.getClassLoader();
        File guildFile = new File(MysticGuild.getInstance().getDataFolder()+"/guild/guild.yml");
        if(!guildFile.exists()){
            try{
        ...
        File alianzFile = new File(MysticGuild.getInstance().getDataFolder()+"/alianz/alianz.yml");
