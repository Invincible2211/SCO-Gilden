package de.fynn.sco.guild.system.utils;
...
public class VariabelManager {
    ...
    static {
        ...
        PREFIX = ConfigHandler.getCustomPrefix().equals("") ? Guild.getInstance().getDescription().getPrefix():ConfigHandler.getCustomPrefix();
