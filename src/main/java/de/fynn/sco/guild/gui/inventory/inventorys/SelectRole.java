...
public class SelectRole extends PageInventory {


    public SelectRole(Player owner, CustomInventory previousInventory, String title, int rows, InventoryPage... pages) {
        super(owner, previousInventory, title, rows, pages);
    }

    public SelectRole(Player owner, String title, int rows, InventoryPage... pages) {
