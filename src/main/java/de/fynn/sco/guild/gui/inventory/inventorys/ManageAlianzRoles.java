...
public class ManageAlianzRoles extends PageInventory {


    public ManageAlianzRoles(Player owner, CustomInventory previousInventory, String title, int rows, InventoryPage... pages) {
        super(owner, previousInventory, title, rows, pages);
    }

    public ManageAlianzRoles(Player owner, String title, int rows, InventoryPage... pages) {
